...
<head>
    ...
    <link rel="stylesheet" href="css/quiz-created.css">
            ...
            <div class="quiz-container">
                <div class="quiz-bg">
                    <div class="quiz-name">
                        ...
                        <h3><?php echo $quizName . ' Created by ' . $username . ' (Lecturer)'; ?></h3>
                    </div>
                    <div class="button-box">
                        <button class="back-to-home-btn" id="bth" onclick="window.location.href='profile.php';"><h3>Back to Home</h3></button>
                    </div>
                </div>
            </div>
        </div>
