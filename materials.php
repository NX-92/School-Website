...
<body>
                        ...
                        <div class="material-container">
                            <div class="material-box">
                                <div class="material-context">
                                    <div class="context1">
                                        <h3><?php echo $learning_Module_Data['Module_Title']; ?></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="materials-exp">
                                ...
                                while ($learning_Material_Data = mysqli_fetch_assoc($result)) { ?>
                                    <div class="materials-context">
                                        <h3>
                                            <a href="<?php echo $learning_Material_Data['Source']; ?>" 
                                            download="<?php echo $learning_Material_Data['Learning_Material_Name']; ?>">
                                                <?php echo $learning_Material_Data['Learning_Material_Name']; ?>
                                            </a>
                                        </h3>
                                        <div class="details">
                                            <p><?php echo $learning_Material_Data['Description']; ?></p>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
    ...
    <script src="open-close.js"></script>
    </section>
