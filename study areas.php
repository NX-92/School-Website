...
<head>
    ...
    <link rel="stylesheet" href="css/studyareas.css">
...
<header class="header">
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="context">
                <span class="bold-font">Abbott University</span> specializes in cutting-edge study areas within the fields of Java, SQL, and Python programming, 
                equipping students with the skills needed for success in the tech industry. The university offers comprehensive 
                courses in software development, database management, and data science, providing hands-on experience in coding, 
                debugging, and optimizing applications. With a strong focus on artificial intelligence, machine learning, and 
                cybersecurity, Abbott University ensures that students stay ahead in emerging technologies. The curriculum also 
                includes cloud computing, web development, and mobile app programming, preparing graduates for diverse career 
                opportunities in software engineering, IT consulting, and data analytics.
            </div>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="module-box">
                        <div class="module-context">
                            <div class="context1">
                                <h3><?php echo $row['Module_Title']; ?></h3>
                                <p>
                                    <?php echo $row['Short_Description']; ?>
                                </p>
                            </div>
                            <div class="context2">
                                <form id="form-<?php echo $row['Module_ID']; ?>" action="module.php" method="post">
                                    <input type="hidden" name="Module_ID" value="<?php echo $row['Module_ID']; ?>">
                                </form>
                                
                                <a href="#" onclick="document.getElementById('form-<?php echo $row['Module_ID']; ?>').submit(); return false;">
                                    <h3>Learn More</h3>
                                </a>
                            </div>
                        </div>
