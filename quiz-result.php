<?php
    ...
    $totalpoint = $_SESSION['Total_Point'];
    $score = $_SESSION['Score'];
    $halfpoint = $totalpoint / 2;
        ...
        <div class="container">
            ...
            <div class="results-container">
                <div class="results-bg">
                    <?php if ($score >= $halfpoint) {?>
                    <div class="pass">
                        <h2>Congrats!</h2>
                        <h3>You passed the quiz.</h3>
                    </div>
                    <div class="passmark">
                        <h1><?php echo $score . ' / ' . $totalpoint; ?></h1>
                    </div>
                    <?php } else {?>
                    <div class="pass">
                        <h2>Unfortunately...</h2>
                    ...
                    <div class="exit-button">
                        <button class="exit-btn" id="Exit" onclick="window.location.href='study areas.php';" ><h3>Exit</h3></button>
                    </div>
                </div>
            </div>
        </div>
